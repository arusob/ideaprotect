						...
						<div class="col-12 col-xs-12 col-sm-9 col-md-8 col-lg-9 tab-content tab-1">
							...
							<table class="content-table">
								<thead>
									<tr>
										...
										<th class="th-3"> Cena PLN </th>
										<th class="th-4"> j. m. </th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td> 1. </td>
										<td>Przegląd hydrantów zewnętrznych podziemnych (DN80). Badanie wyd. i ciśnienia. </td>
										<td> 70,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 2. </td>
										<td> Przegląd hydrantów zewnętrznych nadziemnych (DN100). Badanie wyd. i ciśnienia. </td>
										<td> 65,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 3. </td>
										<td> Przegląd hydrantów zewnętrznych nadziemnych (DN80). Badanie wyd. i ciśnienia. </td>
										<td> 60,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 4. </td>
										<td> Przegląd hydrantów wewnętrznych (DN52). Badanie wyd. i ciśnienia. </td>
										<td> 55,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 5. </td>
										<td> Przegląd hydrantów wewnętrznych (DN33). Badanie wyd. i ciśnienia. </td>
										<td> 50,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 6. </td>
										<td> Przegląd hydrantów wewnętrznych (DN25). Badanie wyd. i ciśnienia. </td>
										<td> 55,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 7. </td>
										<td> Badanie okresowe 5-cio letnie. Badanie ciśnieniowe węży hydrantowych<br/> hydrantów wewnętrznych. </td>
										<td> 50,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 8. </td>
										<td> Przegląd okresowy instalacji tryskaczowej (wodnej) </td>
										<td> 0,50 </td>
										<td> m2 </td>
									</tr>
									<tr>
										<td> 9. </td>
										<td> Przegląd okresowy zestawu hydroforowego do zasilania inst. ppoż. wewnątrz budynku<br>
									...
									<tr>
										<td> 10. </td>
										<td> Przegląd okresowy pompowni do zasilania instalacji przeciwpożarowych zewnętrznych<br>
							...
							<table class="content-table">
								...
								<tbody>
									<tr>
										<td> 11. </td>
										<td> Przegląd okresowy gaśnic. (np. proszkowe, śniegowe, pianowe) - od 6kg </td>
										<td> 10,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 12. </td>
										<td> Przegląd okresowy gaśnic. (np. proszkowe, śniegowe, pianowe) - od 4kg </td>
										<td> 8,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 13. </td>
										<td> Przegląd okresowy gaśnic. (np. proszkowe, śniegowe, pianowe) - 2kg i mniejsze </td>
										<td> 7,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 14. </td>
										<td> Legalizacja gaśnic. (5-cio letnia). </td>
										<td> od 50,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 15. </td>
										<td> Legalizacja UDT dla zbiorników gaśnic. </td>
										<td> od 90,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 16. </td>
										<td> Przegląd okresowy agregatów gaśniczych. </td>
										<td> od 80,00 </td>
										<td> szt. </td>
									</tr>
								</tbody>
							...
							<table class="content-table">
								...
								<tbody>
									<tr>
										<td> 17. </td>
										<td> Przegląd okresowy systemu oddymiania (okna oddymiające dachowe i ścienne) </td>
										<td> od 35,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 18. </td>
										<td> Przegląd okresowy systemu oddymiania (wentylatory oddymiające) </td>
										<td> od 35,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 19. </td>
										<td> Przegląd okresowy systemu oddymiania (klapy odcinające w kanałach wentylacyjnych) </td>
										<td> od 35,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 20. </td>
										<td> Przegląd okresowy drzwi ewakuacyjnych (ze zwalniaczami antypanicznymi <br>i dostępem chronionym) </td>
										<td> od 30,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 21. </td>
										<td> Przegląd okresowy drzwi oddzielenia pożarowego (stalowe, drewniane, profilowe). </td>
										<td> od 20,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 22. </td>
										<td> Przegląd okresowy bram, kurtyn oddzielenia pożarowego. </td>
										<td> od 40,00 </td>
										<td> szt. </td>
									</tr>
								</tbody>
							...
							<table class="content-table">
								...
								<tbody>
									<tr>
										<td> 23. </td>
										<td> Przegląd okresowy systemu sygnalizacji pożarowej. Centrale sygnalizacji pożaru.<br> 
											(np. Polon-Alfa, Bosh, Schrack, Satel, Inim Electronics, Awex, inne). </td>
										<td> od 895,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 24. </td>
										<td> Przegląd okresowy instalacji sygnalizacji pożarowej. Czujki wykrywające pożar <br>(dymu, ciepła, liniowe). </td>
										<td> od 20,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 25. </td>
										<td> Przegląd okresowy ręcznego ostrzegacza pożarowego. </td>
										<td> od 60,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
							...
							<table class="content-table">
								...
								<tbody>
									<tr>
										<td> 27. </td>
										<td> Przegląd okresowy instalacji oświetlenia awaryjnego. </td>
										<td> 35,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 28. </td>
										<td> Przegląd okresowy instalacji oświetlenia ewakuacyjnego. </td>
										<td> 35,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 29. </td>
										<td> Przegląd okresowy przeciwpożarowego wyłącznika prądu. </td>
										<td> od 120,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 30. </td>
										<td> Przegląd okresowy systemu detekcji gazów (np. w garażu - czujniki CO i LPG) </td>
										<td> od 35,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 31. </td>
										<td> Przegląd konserwacyjny biernego systemu ochrony przeciwpożarowej <br>
						...
						<div class="container-sm col-xs-12 col-sm-12 col-lg-9 tab-content">
							...
							<table class="content-table">
								...
								<tbody>
									<tr>
										<td> 1. </td>
										<td> Analiza stanu bezpieczeństwa i higieny pracy. Raport roczny. </td>
										<td> od 1400,00 </td>
										<td> firma </td>
									</tr>
									<tr>
										<td> 2. </td>
										<td> Ocena ryzyka zawodowego. Wykonanie nowej dokumentacji. </td>
										<td> 240,00 </td>
										<td> stanowisko </td>
									</tr>
									<tr>
										<td> 3. </td>
										<td> Ocena ryzyka zawodowego. Aktualizacja istniejącej dokumentacji. </td>
										<td> 160,00 </td>
										<td> stanowisko </td>
									</tr>
									<tr>
										<td> 4. </td>
										<td> Ocena warunków pracy przy monitorach ekranowych. </td>
										<td> 160,00 </td>
										<td> stanowisko </td>
									</tr>
								</tbody>
							...
							<table class="content-table">
								...
								<tbody>
									<tr>
										<td> 5. </td>
										<td> Protokół z ustalenia okoliczności i przyczyn wypadku przy pracy. </td>
										<td> od 450,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 6. </td>
										<td> Karta wypadku w drodze do pracy lub z pracy. </td>
										<td> od 380,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 7. </td>
										<td> Dokumentacja wypadkowa dla wypadków w delegacji (zrównane). </td>
										<td> od 520,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
							...
							<table class="content-table">
								...
								<tbody>
									...
									<tr>
										<td> 10. </td>
										<td> Plan bezpieczeństwa i ochrony zdrowia. (Plan BIOZ). </td>
										<td> od 1600,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
							...
							<table class="content-table">
								...
								<tbody>
									<tr>
										<td> 16. </td>
										<td> Instrukcja bezpieczeństwa i higieny pracy. </td>
										<td> 20,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 17. </td>
										<td> Instrukcja bezpieczeństwa i higieny pracy z substancjami o określonych właściwościach <br> fizycznych, chemicznych, biologicznych. </td>
										<td> 20,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 18. </td>
										<td> Instrukcja bezpieczeństwa i higieny pracy urządzeń i instalacji elektrycznych. </td>
										<td> 20,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 19. </td>
										<td> Instrukcja bezpieczeństwa i higieny pracy dla określonych procesów pracy. </td>
										<td> 20,00 </td>
										<td> szt. </td>
									</tr>
								</tbody>
						...
						<div class="container-sm col-xs-12 col-sm-12 col-lg-9 tab-content">
							...
							<table class="content-table">
								...
								<tbody>
									...
									<tr>
										<td> 7. </td>
										<td> Szkolenie z dziedziny BHP okresowe dla pracodawców i kierujących pracownikami. </td>
										<td> 300,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 8. </td>
										<td> Szkolenie z dziedziny BHP okresowe dla pracowników administracyjno-biurowych. </td>
										<td> 60,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 9. </td>
										<td> Szkolenie z dziedziny BHP okresowe dla pracowników inżynieryjno-technicznych. </td>
										<td> 120,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
										<td> 10. </td>
										<td> Szkolenie z dziedziny BHP okresowe dla pracowników robotniczych. </td>
										<td> 60,00 </td>
										<td> szt. </td>
									</tr>
									<tr>
