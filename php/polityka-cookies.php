				...
				<div class="row row-content bg-con-1 col-md-12 d-block">
					...
					<div>
						<p>
							...
							1. Aby nasza strona internetowa funkcjonowała poprawnie, w chwili gdy ją odwiedzasz, używamy technologii o nazwie „pliki cookie”. 
							Są to pliki wysyłane do Twojego komputera wobec których później możemy się odnieść. Mogą to być pliki cookie sesyjne 
							bądź trwałe ("session" lub "persistent cookies") i mogą korzystać z technologii takiej jak JavaSript lub Flash. Pliki cookie pomagają 
							...
							wpisywać ich za każdym razem.<br/>
							...
							lub usługi witryny nie będzie działać prawidłowo.<br/>
