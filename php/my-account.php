	...
	<section class="my-account bg-con-1">
		<div class="row row-content">
			...
			<div class="col-lg-12" style="margin-top: 60px;">
				<br>
				<a href="php/create-worker-form.php" class="btn btn-primary">Dodaj pracownika +</a>
				<br><br>
					...
					<?php 
						foreach($workers as $worker){
							echo '<tr>';
								...
								echo '<td><a href="php/edit-worker-form.php?workerId='.$worker['id'].'"><img class="crud-icon" src="../img/pencil.png"></a></td>';
								echo '<td><a href="php/delete-worker-form.php?workerId='.$worker['id'].'"><img class="crud-icon" src="../img/trash.png"></a></td>';
							echo '</tr>';
						}
					?>
					</tbody>
