			...
			<section class="about-us-page">
				<div class="row row-content bg-con-1 company">
					...
					<div class="row">	
						...
						<div class="col-xl-6 col-xxl-4">
							<img class="dot img-fluid" src="../img/signboard-ideaprotect.png">
						</div>	
					</div>
				</div>
				...
				<div class="row row-content bg-con-1 team">					
					<div class="col-md-12 d-block">
						<h1 class="text-center headline font-weight-bold"> Nasz zespół </h1>
					</div>					
					<div class="container col-md-12 d-block">						
						<div class="row team-container">							
							<div class="col-md-12 col-lg-4">
								<div class="our-team mx-auto">
									<div class="pic">
										<img src="../img/worker-arek.png">
									</div>
									...
									<ul class="social">
										...
										<li>
											<a href="https://www.youtube.com/channel/UC220CnGbppJtW_eWuZU7-CA/featured" class="fa fa-youtube" target="_blank"></a>
										</li>
									</ul>
								</div>
							</div>			
							...
							<div class="col-md-12 col-lg-4 ">
								<div class="our-team mx-auto">
									...
									<ul class="social">
										...
										<li>
											<a href="https://www.youtube.com/channel/UC220CnGbppJtW_eWuZU7-CA/featured" class="fa fa-youtube"></a>
										</li>
									</ul>
								</div>
							</div>
				...
				<div class="row row-content bg-con-2 trust-us" >
					<div class="col-md-12 d-block">
						<h1 class="text-center headline font-weight-bold"> Dlaczego warto nam zaufać ?</h1>
					</div>
					<div class="col-md-12 d-block">
				...
				<div class="row row-content bg-con-1 bussines-in-numbers" >
					<div class="col-md-12 d-block">
						<h1 class="text-center headline font-weight-bold"> Nasza działalność w liczbach </h1>
					</div>
					<div class="col-md-12 d-block">
						<div class="row justify-content-center">
							<div class="wrapper col-md-3 text-center">
								<img src="../img/risk-management.png">
								<div class="counter" data-count="79"> 0 </div>
								<p class="px-2 font-weight-bold"> OCEN RYZYKA ZAWODOWEGO </p>
							</div>
							<div class="wrapper col-md-3 text-center" >
								<img src="../img/fire-safety-instruction (2).png" >
								<div class="counter" data-count="33"> 0 </div>
								<p class="px-2 font-weight-bold"> PRZEGLĄDÓW ZABEZPIECZEŃ PPOŻ. </p>
							</div>
							<div class="wrapper col-md-3 text-center">
								<img src="../img/fire-safety-instruction-3.png">
								<div class="counter" data-count="21"> 0 </div>
								<p class="px-2 font-weight-bold"> INSTRUKCJI BEZPIECZEŃSTWA </p>
							</div>
							<div class="wrapper col-md-3 text-center">
								<img src="../img/experience-work-3.png">
								<div class="counter" data-count="8"> 0 </div>
								<p class="px-2 font-weight-bold"> LAT <br/> DOŚWIADCZENIA </p>
							</div>
						</div>
					</div>	
				</div>
